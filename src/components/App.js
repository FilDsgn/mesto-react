  ...
  return (
    <div className="App">
      ...
      onClose={closeAllPopups}>
        <input name="name" type="text" placeholder="Ваше имя" minLength="2" maxLength="40" required id="username"
              className="popup__input popup__input_place_name" />
        <span className="username-error popup__input-error"></span>
        <input name="about" type="text" placeholder="Дополнительная информация" minLength="2" maxLength="200" required
              id="about" className="popup__input popup__input_place_about" />
      ...
      onClose={closeAllPopups}>
        <input name="avatar" type="url" placeholder="Ссылка на картинку" id="image-link"
      ...
      onClose={closeAllPopups}>
        <input name="name" type="text" placeholder="Название" minLength="2" maxLength="30" required id="locate-name"
              className="popup__input popup__input_place_locate" />
        <span className="locate-name-error popup__input-error"></span>
        <input name="link" type="url" placeholder="Ссылка на картинку" id="avatar-link"
              className="popup__input popup__input_place_image" required />
